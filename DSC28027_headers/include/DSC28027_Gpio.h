...
#ifndef DSC28027_GPIO_H
#define DSC28027_GPIO_H
...
struct GPA1_BITS {            // bits   description
   ...
   Uint32 rsvd1:8;				// 16 - 23
   Uint32 GPIO12:2;            // 24-25  GPIO12
...
struct GPA2_BITS {            // bits   description
   ...
   Uint32 rsvd1:16;
   Uint32 GPIO28:2;           // 24-25    GPIO28
   Uint32 GPIO29:2;           // 26-27  GPIO29
   Uint32 rsvd2:4;
